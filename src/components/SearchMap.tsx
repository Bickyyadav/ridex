...
type props = {
    pickUp: string,
    drop: string,
    onChange: (p: string, q: string) => void;
    onDistance: (d: number) => void
}

//fit lat and lon in map perfect
...
const SearchMap = ({ pickUp, drop, onChange, onDistance }: props) => {
    ...
    //with the help of address we are finding latitude and longitude
    ...
    //reverse geocoding means lat and long to give proper address 
    ...
    //this will give you the whole route from pick to drop all lat and long will they give you 
    ...
    return (
        <div className='relative h-full w-full bg-zinc-100'>
            <MapContainer style={{ width: "100%", height: "100%" }}
                ...
                />}
                {/* this is for to shwo the line in map */}
                {route.length > 0 && (
                    <>
